<template lang="html">
  <form class="" v-on:submit="addGame" method="post">
    ...
    <input type="number" id="playingTime" v-model="playingTime"/>

    <label for="minNumPlayers">Min Players:</label>
    <input type="number" id="minNumPlayers" v-model="players.min"/>

    <label for="maxNumPlayers">Max Players:</label>
    <input type="number" id="maxNumPlayers" v-model="players.max"/>
